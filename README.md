...
| Deep Learning | Red servo 4-64-32-16-8-1 (800 ép.) y red aware 8-96-64-32-16-8-3 (1200 ép.), método adjunto |
| Q-Learning | Tabla Q TD(0): servo 100 estados/8 acciones, aware 162 estados/11 acciones |

Planta de Fase 1: discretización ZOH de la función de transferencia asignada en la guía,
`Gp(s) = (0.174 s + 0.3744)/(s^2 + 0.785 s + 0.3744)`. Fase 2: balance de masa de las dos esteras.
