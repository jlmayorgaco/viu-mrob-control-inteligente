...
Deep Learning & Optimización directa sobre planta & Entrena la política \emph{offline} sobre el gemelo digital, minimizando el IAE mediante retropropagación a través de la simulación discreta. La inferencia en despliegue es de coste computacional fijo por ciclo \cite{reinoso2022redes}.\\[4pt]
...
$u_i$ & $[0.05,\;0.98]$\newline(norm.) & 7 niveles (FAM por nivel de error/derivada) & Velocidad de descarga de estera $i$\\
