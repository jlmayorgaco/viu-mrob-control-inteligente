...
\footnote{Se emplea el punto como separador decimal por coherencia con el código, los archivos CSV y las figuras generadas.}

Todas las simulaciones corren en tiempo discreto, con parámetros fijos y reproducibles. El Apéndice~A incluye extractos representativos del código; los scripts completos de simulación, entrenamiento y generación de figuras se entregan junto con el informe.
