...
\begin{itemize}
  ...
  \item Factor de amortiguamiento: $\zeta = \dfrac{0.785}{2\,\omega_n} = \dfrac{0.785}{1.224} = 0.641$ \quad (subamortiguado con oscilación leve, próximo al amortiguamiento crítico)
