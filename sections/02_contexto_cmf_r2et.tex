...
Que el robot alterne es lo fácil. Lo difícil es decidir \emph{cuánto} alimentar a cada estera y \emph{a qué velocidad} descargarlas. Tres situaciones lo complican.

La primera es la saturación. Si el robot sigue depositando piezas sobre una estera casi llena, el margen se agota en pocas muestras, así que el control tiene que anticiparla y redirigir el flujo antes de que ocurra.

La segunda es la opuesta, el vaciado: con una descarga demasiado rápida frente al flujo de entrada, la estera se queda vacía y la línea de salida se corta. Por eso el nivel objetivo se fija en $1.5$~piezas, el $50\%$ de la capacidad, que deja margen en ambos sentidos.

La tercera es el cambio de peso. Las piezas más pesadas rozan más sobre la estera y la eficiencia de descarga cae hasta un $35\%$ en E1 y un $17.5\%$ en E2 mientras dura la perturbación. El controlador debe notar esa caída y reaccionar (acelerar la estera, recortar la admisión o desviar el robot hacia E2) sin esperar a que el nivel toque el umbral de alarma.
