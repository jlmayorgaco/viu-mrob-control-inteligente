...
Qué es el supervisor. Es un sistema basado en reglas, no una red neuronal ni una caja negra. Funciona como una máquina de estados sobre el nivel de congestión, con tres regímenes (\emph{Normal}, \emph{Riesgo} y \emph{Alarma}): programa las ganancias del PID (\emph{gain scheduling}), ajusta la admisión de piezas y, con un bloque difuso Mamdani, decide el reparto del robot entre esteras. Toda su lógica son umbrales y factores fijos, explícitos y auditables, que es justo lo que se le pide a una capa de seguridad. Por dentro tiene dos niveles: uno de ajuste adaptativo, que modifica las ganancias del PID o condiciona la salida de Fuzzy/DL/QL, y otro de seguridad de capacidad, una barrera dura que actúa siempre, sea cual sea el controlador activo.
